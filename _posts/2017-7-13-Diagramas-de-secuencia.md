...
![Primera parte](../img/DdS/img1.PNG "Diagrama de secuencias")
...
![Segunda parte](../img/DdS/img2.PNG "Diagrama de secuencias")
...
![Tercera parte](../img/DdS/img3.PNG "Diagrama de secuencias")
...
![Cuarta parte](../img/DdS/img4.PNG "Diagrama de secuencias")
...
![Ultima parte](../img/DdS/img5.PNG "Diagrama de secuencias")

Por ultimo hacer un pequeño comentario de las diferentes funciones o partes del código:
![Ultima parte](../img/DdS/img6.PNG "Diagrama de secuencias")

**CODIGO COMPLETO:**
![Codigo completo](../img/DdS/UsuarioTwitchTV.png "Diagrama de secuencias")
